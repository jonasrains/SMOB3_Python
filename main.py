...
def center_camera():
    ...
    marx = (round(mario.x_pos / 2) - 8) * 2
    mary = (round(mario.y_pos / 2) - 16) * 2
    if marx < camx_min:
        camx = camx_min
    elif marx > camx_max:
        camx = camx_max
...
while running:
    ...
    if mario.direction == 90:
        display.blit(mario.image, (marx - camx + 256, mary - camy + 186))
    else:
        display.blit(pygame.transform.flip(mario.image, True, False), (marx - camx + 256, mary - camy + 186))
